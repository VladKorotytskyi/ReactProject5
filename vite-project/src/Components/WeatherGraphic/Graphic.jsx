...
export const Graphic = ({ temp = 15 }) => {
  const labels = ["11 pm", "Oct 14", "1 am", "2 am", "3 am", "4 am", "5 am", "6 am", "7 am", "8 am", "9 am", "10 am", "11 am", "12 am", "1 pm", "2 pm", "3 pm", "4 pm", "5 pm", "6 pm"];

  const dynamicData = useMemo(() => {
    return [
      temp - 2, temp - 3, temp - 4.5, temp - 5, temp - 5.5, temp - 5, 
      temp - 4, temp - 2, temp - 1, temp + 1, temp + 3, temp + 5, 
      temp + 7, temp + 8, temp + 9, temp + 10, temp + 11, temp + 11.5, 
      temp + 11.8, temp + 12
    ];
  }, [temp]);
